...
const CITY_COORDINATES: Record<string, { lat: number; lng: number; label: string }> = {
  ...
  "KOTA BOGOR": { lat: -6.5950, lng: 106.8166, label: "Kota Bogor" },
  "KAB. BEKASI": { lat: -6.2625, lng: 107.1333, label: "Kab. Bekasi" },
  "KOTA BEKASI": { lat: -6.2383, lng: 106.9756, label: "Kota Bekasi" },
  "KOTA DEPOK": { lat: -6.4025, lng: 106.7942, label: "Kota Depok" },
  ...
  "KAB. BANDUNG": { lat: -7.0251, lng: 107.5198, label: "Kab. Bandung" },
  "KAB. BANDUNG BARAT": { lat: -6.8435, lng: 107.4947, label: "Bandung Barat" },
  "KOTA CIMAHI": { lat: -6.8723, lng: 107.5420, label: "Cimahi" },
  "KAB. GARUT": { lat: -7.2279, lng: 107.9087, label: "Garut" },
  "KOTA CIREBON": { lat: -6.7320, lng: 108.5523, label: "Kota Cirebon" },
  "KAB. CIREBON": { lat: -6.7600, lng: 108.4800, label: "Kab. Cirebon" },
  "KAB. SUKABUMI": { lat: -6.9277, lng: 106.9299, label: "Kab. Sukabumi" },
  "KOTA SUKABUMI": { lat: -6.9217, lng: 106.9267, label: "Kota Sukabumi" },
  "KAB. CIANJUR": { lat: -6.8173, lng: 107.1427, label: "Cianjur" },
  "KOTA TASIKMALAYA": { lat: -7.3274, lng: 108.2207, label: "Kota Tasikmalaya" },
  "KAB. TASIKMALAYA": { lat: -7.3587, lng: 108.1066, label: "Kab. Tasikmalaya" },
  "KAB. CIAMIS": { lat: -7.3258, lng: 108.3533, label: "Ciamis" },
  "KOTA BANJAR": { lat: -7.3697, lng: 108.5323, label: "Banjar" },
  "KAB. PANGANDARAN": { lat: -7.7000, lng: 108.4900, label: "Pangandaran" },
  "KAB. KUNINGAN": { lat: -6.9760, lng: 108.4831, label: "Kuningan" },
  "KAB. MAJALENGKA": { lat: -6.8361, lng: 108.2274, label: "Majalengka" },
  "KAB. SUMEDANG": { lat: -6.8586, lng: 107.9266, label: "Sumedang" },
  "KAB. INDRAMAYU": { lat: -6.3264, lng: 108.3200, label: "Indramayu" },
  "KAB. SUBANG": { lat: -6.5716, lng: 107.7587, label: "Subang" },
  "KAB. PURWAKARTA": { lat: -6.5569, lng: 107.4433, label: "Purwakarta" },
  "KAB. KARAWANG": { lat: -6.3073, lng: 107.3074, label: "Karawang" }
};
